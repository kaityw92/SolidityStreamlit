...
from web3.gas_strategies.time_based import medium_gas_price_strategy, glacial_gas_price_strategy
...
def send_transaction(w3, account, to, wage):
    ...
    w3.eth.set_gas_price_strategy(glacial_gas_price_strategy)
